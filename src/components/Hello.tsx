  ...
  return (
    <section className=' mt-[60px] md:mt-[40px]  relative lg:flex lg:justify-center lg:gap-3 3xl:gap-96'>
      <div className='flex flex-col items-center lg:w-[70%]'>
        ...
        <span className='text-gray2  leading-[120%] font-medium text-[20px] md:text-[20px] md:leading-[110%]  lg:text-2xl mb-[365px] md:mb-[20px] 3xl:mb-16'>
          Унікальний ШI-помічник{' '}
        </span>
        {/* Icon1AI */}

        <div className=' absolute top-[30px] left-[50%] translate-x-[-50%] flex items-center justify-center w-full md:top-[70px] md:left-[-350px] md:w-[768px] md:h-[602px] md:translate-x-[0] lg:top-[480px] lg:left-[-200px] 3xl:w-[729px] 3xl:h-[672px] 3xl:left-[-200px] 3xl:top-[500px]'>
        ...
        <div className='flex flex-col w-[200px] md:w-0 items-center justify-center mb-8 mt-8 md:mt-0 md:mb-[30px] md:flex-row md:gap-8 3xl:gap-20 '>
          <div className='flex flex-col mb-[30px] md:mb-0 items-center '>
            ...
            <p className='text-[#B8B8B8] mt-[7px] mb-[6px] 3xl:mb-3 text-base 3xl:text-xl text-center'>
              Користувачів
            </p>
            <div
          ...
          <div className='flex flex-col items-center'>
            ...
            <p className='text-[#B8B8B8] mt-[7px] mb-[6px] text-base 3xl:text-xl 3xl:mb-3'>
              Для бізнесу
            </p>
            <div
              className='w-[140px] h-[3px] rounded-[59px]'
        ...
        <BtnBig className='bg-purple h-[139px] w-[139px]  gap-[10px] 1xl:h-[158px] 1xl:w-[158px] 2xl:h-[216px] 2xl:w-[216px] lg:h-[142px] lg:w-[142px] xl:h-[145px] xl:w-[145px] relative z-10'>
          <svg
          ...
          <span className='text-[16px] leading-[130%] uppercase  font-semibold  3xl:text-2xl'>
            спробувати
          </span>
        </BtnBig>
      </div>
