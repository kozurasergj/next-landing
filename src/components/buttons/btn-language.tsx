  ...
  return (
    <>
      <button
        ...
        className={
          `flex-center flex-col gap-[6px] rounded-full w-[20px] h-[20px] md:w-[28px] md:h-[28px] lg:w-[40px] lg:h-[40px] ${props.className}`
        }
        ref={wrapRef}
      >
        <div
          className={
            'flex-center h-[20px] w-[20px] md:w-[28px] md:h-[28px] lg:w-[40px] lg:h-[40px]'
          }
        >
